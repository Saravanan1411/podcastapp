...
class _PlaySongState extends State<PodcastPlayer> {
  ...
  List<PodcastDetailsDataModel> _queue = [];
                        ...
                        Column(
                          children: [
                            ...
                            for (var song in _queue)
                              ListTile(
                                title: Text((podcastDataModelList[_currentSongIndex].title).toString()),
                                subtitle: Text((podcastDataModelList[_currentSongIndex].title).toString()),
                                // You can customize the appearance of each item in the queue
                              ),
                          ],
                        ),
                    ],
  ...
  void _skipToNext() {
    if (_currentSongIndex < podcastDataModelList.length - 1) {
      ...
      _audioPlayer.play();
      _updateQueue(); // Update the queue when skipping to the next song
      setState(() {});
    }
  }
  ...
  void _updateQueue() {
    _queue.clear();
    for (var i = _currentSongIndex + 1; i < podcastDataModelList.length; i++) {
      _queue.add(podcastDataModelList[i]);
    }
  }
